 ...
 * @author Kevin
 */
public class ClientesRegistradosTP extends javax.swing.JFrame {
     ...
     */
    public ClientesRegistradosTP(RegistroClientes registroClientes, ArrayList<String> validador) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesRegistradosTP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesRegistradosTP().setVisible(true);
            }
        });
    }
