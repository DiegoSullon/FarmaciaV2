...
public class AgregarCliente extends javax.swing.JPanel {
    ...
    /**
     * Creates new form SelectRC
     */
    int n;
    public AgregarCliente(RegistroClientes registroClientes) {
        this.registroClientes = registroClientes;
        initComponents();
    }
    
    public AgregarCliente(RegistroClientes registroClientes,ArrayList<String> validador) {
        this.registroClientes = registroClientes;
    ...
    private void botonPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPActionPerformed
        ...
        new CambiaPanel(pnlPrincipal,new Panels.AgregarPersona(registroClientes,validador));
    }//GEN-LAST:event_botonPActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new CambiaPanel(pnlPrincipal,new Panels.AgregarEmpresa(registroClientes,validador));
